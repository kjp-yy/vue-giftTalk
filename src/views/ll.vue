    ...
    <div class="magnify">
      ...
      <div class="left_contaner">
        <div class="middle_img" @mouseover="boxMouseOver" @mouseleave="boxMouseLeave">
          ...
          <div
            class="shade"
            style="width: 175px; height: 175px; left: 121.5px; top: 82.5px;"
...
.left_contaner .carousel .left_arrow {
  background: url("http://www.jq22.com/demo/jQuery-fdj201705051102/images/btn_prev.png")
    no-repeat;
  background-position: center center;
}
.left_contaner .carousel .right_arrow {
  background: url("http://www.jq22.com/demo/jQuery-fdj201705051102/images/btn_next.png")
    no-repeat;
